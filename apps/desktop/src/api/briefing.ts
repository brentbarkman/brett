...
export function useBriefing() {
  ...
  // Stash regenerate in a ref so the auto-generate effect doesn't re-fire
  // every render (regenerate is a fresh closure each time). The ref always
  // points at the latest regenerate, and the auto-generate gate uses
  // hasAutoGeneratedRef so it only fires once.
  ...
  }, [hasAI, briefingQuery.isLoading, cachedBriefing, isGenerating]);
