...
/// timeline filters in `CalendarPage.visibleEvents` and
/// `TodayPage.nextUpcomingEvent` so a user-organized event stays
/// visible even when declined — matches Google Calendar's behaviour
/// of never hiding events you organized from "Hide declined events".
///
