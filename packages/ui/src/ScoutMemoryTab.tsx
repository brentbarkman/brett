...
function MemoryCard({
  ...
  return (
    <div className="group flex gap-3.5 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
      <div
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="h-0.5 rounded-full bg-white/10 mt-2">
          <div
      ...
      <button
        ...
        className="flex-shrink-0 w-7 h-7 flex items-center justify-center rounded-md opacity-0 group-hover:opacity-100 hover:bg-white/10 text-white/30 hover:text-white/50 transition-all"
      >
        <X size={14} />
      </button>
    </div>
